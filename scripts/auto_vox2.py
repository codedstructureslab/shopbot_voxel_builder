...
USAGE:
  mspython auto_vox2.py <geometry> <filename>
  (old) mspython auto_vox2.py >> ./SBP_output/<filename>.SBP
  (old) mspython auto_vox2.py <geometry>
...
def output_shopbot_build(voxMatrix):
    ...
    SBP_output.append("''AUTOGENERATED by auto_vox2.py (EDIT w/ CAUTION)\n")
    ...
    SBP_output.append("\'\'Voxel size [in.] " + str([round(vgeo[0]*mm2in,1),round(vgeo[1]*mm2in,1),round(vgeo[2]*mm2in,1)]) + '\n\'\'\n')
